...
class Course
{
    ...
    /** @brief Integer that is increased after every problem insertion. Allows an easy way to check whether the Course follows the no intersection rule between problems from sessions. */
    int expected_size = 0;
    ...
    */
    void insertion(const string& session_id);
    public:
	Course();
	/**
	  @pre Always true.
